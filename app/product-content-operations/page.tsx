    ...
    <main className="product-detail-shell">
      ...
      <div className="product-detail-canvas">
        <header className="product-detail-header">
          <a className="product-brand" href="/#home-top" aria-label="返回主页">SUYUE</a>
        ...
        <footer id="contact" className="product-detail-footer footer-sticker" data-footer-sticker>
          ...
          <nav className="product-footer-nav footer-directory" style={box(710, 15430, 1080, 925)} aria-label="页尾导航">
